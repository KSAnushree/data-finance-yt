...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-full mx-auto px-4 text-white">
      <h1 className="w-full text-4xl font-bold text-green-600 m-6">REACT.</h1>
      ...
      <div
        className={
          !nav
            ? "fixed left-0 top-0 w-[20%] h-full border-r border-r-gray-900 bg-black ease-in-out duration-500"
            : "fixed left-[-100%]"
        }
      >
        <h1 className="w-full text-4xl font-bold text-green-600 m-9">REACT.</h1>
